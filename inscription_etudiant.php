...
<body>
  ...
  <div class="hero_area">
    ...
    <center>
     ...
     <input type="text" id="name" name="name_de_famille" required minlength="4" maxlength="25" size="15" /><br>
     <label for="name">Prénom : </label> 
     <input type="text" id="name" name="name" required minlength="4" maxlength="25" size="15" /><br>
     <label for="name">Email : </label>
     <input type="text" id="name" name="email" required minlength="4" maxlength="25" size="15" /><br>
     <label for="name">Mot de passe : </label>
     <input type="text" id="name" name="password" required minlength="4" maxlength="25" size="15" /><br>
     <label for="name">Nom de famille (Promo) : </label>
<input type="text" id="name" name="name_de_famille_promo" required minlength="4" maxlength="25" size="15" /><br>
<label for="name">Année de Promo : </label>
<input type="text" id="name" name="annee_promo" required minlength="4" maxlength="25" size="15" /><br>
  </div>
  <div>
  <h3><button class="nav-link dropbtn">IN
                      </button>
