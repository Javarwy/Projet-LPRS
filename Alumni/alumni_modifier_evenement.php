...
<div class="hero_area">
    ...
    <center>
        ...
        if (isset($_SESSION['id']) && $_SESSION['role'] == "alumni" && isset($_POST['id_evenement']) || isset($_SESSION['id_evenement'])){
            ?>
            ...
            <div id="modifParticipants" style="display: none; pointer-events: none;">
                ...
                <br>
                <form method="post" action="../PHP/controleur/ModifierEvenementAlumniController.php" id="gestionParticipants">
            ...
            <div id="modifInfos" style="display: none; pointer-events: none;">
                ...
                <br>
                <form method="post" action="../PHP/controleur/ModifierEvenementAlumniController.php" id="modifier" class="form_inscription">
                    <table style="text-align: center;">
                        ...
                        foreach($res as $evenement){
                            ...
                            <tr>
                                <td colspan="2">
                                    <button type="submit" name="modifierAlumni">Envoyer pour validation</button>
                                </td>
                            </tr>
                            <?php
                        }
            ...
            <div>
                <br>
                <a href="evenement_ancien_eleve.php"><button type="button">Retour à la page des événements</button></a>
            </div>
            <?php
        } else {
            ?>
