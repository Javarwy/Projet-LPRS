...
$bdd = new Bdd;
if (!isset($_POST['nomEvenement']) || !isset($_POST['type']) || !isset($_POST['descriptionEvenement']) || !isset($_POST['adresse']) || !isset($_POST['nbDePlaces']) || !isset($_POST['dateEvenement']) || !isset($_POST['id_utilisateur'])){
    header('Location: ../../professeur/prof_creer_evenement.php?erreur=1');
} else {
    if (empty($_POST['nomEvenement']) || empty($_POST['type']) || empty($_POST['descriptionEvenement']) || empty($_POST['adresse']) || empty($_POST['nbDePlaces']) || empty($_POST['dateEvenement']) || empty($_POST['id_utilisateur'])){
        header('Location: ../../professeur/prof_creer_evenement.php?erreur=1');
    } else {
