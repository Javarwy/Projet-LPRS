...
<head>
    ...
    <title>Etudiant - Modifier un événement</title>
...
<div class="hero_area">
    ...
    <center>
        ...
        if (isset($_SESSION['id']) && $_SESSION['role'] == "etudiant" && isset($_POST['id_evenement']) || isset($_SESSION['id_evenement'])){
            ?>
            ...
            <div id="modifParticipants" style="display: none; pointer-events: none;">
                ...
                <br>
                <form method="post" action="../PHP/controleur/ModifierEvenementEtudiantController.php" id="gestionParticipants">
            ...
            <div id="modifInfos" style="display: none; pointer-events: none;">
                ...
                <br>
                <form method="post" action="../PHP/controleur/ModifierEvenementEtudiantController.php" id="modifier" class="form_inscription">
                    <table style="text-align: center;">
                        ...
                        foreach($res as $evenement){
                            ...
                            <tr>
                                <td colspan="2">
                                    <button type="submit" name="modifierEtudiant">Envoyer pour validation</button>
                                </td>
                            </tr>
                            <?php
                        }
            ...
            <div>
                <br>
                <a href="evenement_etudiants.php"><button type="button">Retour à la page des événements</button></a>
            </div>
            <?php
        } else {
            ?>
