...
<head>
    ...
    <title>Nouveau Message - Lycée Privé Robert Schuman</title>
...
<div class="hero_area">
    ...
    <center>
        <b><h1>Message</h1></b>
        <br>
        <h5>Allez-y, ne soyez pas timide. Nos messages sont modérés. </h5>
        <br>
        <br>
        <div>
            <form action="PHP\controleur\TraitementForum.php" method="post" class="forum_message">
                <h3>
                    Titre :</h3>
                <input type="text" id="name" name="titre" required minlength="3" maxlength="20" size="25" required />
        </div>
        <div>
            <br>
            <br>
            <h3>
                <div>
                    <h3>
                        Message :</h3>
                    <input type="text" id="message" name="message" required minlength="3" maxlength="150" size="10" required />
                </div>
                <div>
                    <br>
                    <br>
                    <h3>
                        Canal :</h3>
                    <select name="canal" id="choix-canal">
                        <option value="">--Choisir--</option>
                        <option value="T1">Theme1</option>
                        <option value="T2">Theme2.5</option>
                        <option value="T3">Theme3</option>
                        <option value="T4">Theme4</option>
                    </select>
                <div>
                    <br>
                    <br>
