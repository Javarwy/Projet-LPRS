...
<body>
  ...
  <div>
  <h3><button class="nav-link dropbtn">PE
                      </button>
                          <a href="#">Professeur</a></h3>
  </div>
  <div>
  <h3><button class="nav-link dropbtn">AL
                      </button>
                          <a href="#">Alumni (ou ancien eleve)</a></h3>
  </div>
  <div>
  <h3><button class="nav-link dropbtn">EN
                      </button>
                          <a href="#">Entreprise</a></h3>
  </div>
